        ...
        render: function () {
            ...
            for (var user in Engine.playerInfo) {
                ...
                if (Engine.playerInfo[user].demo === false) {
                    ...
                    nTotalBetsReal += parseInt(Engine.playerInfo[user].rangeBet.amount) / 100;
            ...
            return D.div({className: 'tab-pane active', id: 'tab_manual', style: {marginBottom: '3px', height: '100%'}},
                topDiv,
                switchDiv
            );
        }
