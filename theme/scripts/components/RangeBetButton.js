define([
    ...
    return React.createClass({
        ...
        propTypes: {
            ...
            rangeBetSize: React.PropTypes.string.isRequired,
        ...
        render: function () {
            ...
            if (notPlayingOrBetting) {
                ...
                if (isBetting) {
                    ...
                    // if (this.props.engine.gameState == 'STARTING') {
                    //     btnContent.push(D.span({ key: 'bc-0'}, smallButton ? (languageFlag ? 'Betting3' : '准备') : (languageFlag ? 'Betting...4 Cancel' : '准备...')));
                    //     onClickFun = this.props.cancelBet;
                    //     btnClasses += ' cancel';
                    // }
            ...
            // The user is playing
                ...
                //             D.span({className: 'cashout-cont'}, languageFlag ? 'Cash out16' : '获取算力资源'),
                ...
                //     btnContent.push(
                //         D.div({className: 'btn-content', key: 'bc-6'},
                //             D.span({className: 'cashout-cont'}, languageFlag ? 'Cash out17' : '获取算力资源')
                //         )
                //     );
                // }
                //
