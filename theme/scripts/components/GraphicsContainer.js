    ...
    return React.createClass({
        ...
        render: function () {
            ...
            for (var user in Engine.playerInfo) {
                ...
                nTotalBets += parseInt(Engine.playerInfo[user].rangeBet.amount) / 100;
            }
            ...
            return D.div({ className: 'row'},
                ...
                D.div({ id: 'id_advertisementContainer_before', style:{display:'none'}}),
                D.div({id: 'id_advertisementContainer', style:{display:'none'}},
                    D.div(null,
                        D.img({id: 'id_imageAdvertisement_1', src: '/img/advertisement_1.jpg', style: {width: '100%', height: '100%'}})
                    ),
                    D.div({id: 'id_divAdvertisement_2'},
                        D.img({id: 'id_imageAdvertisement_2', src: '/img/advertisement_2.jpg', style: {width: '100%', height: '100%'}})
                    ),
                    D.div({id: 'id_divAdvertisement_3'},
                        D.img({id: 'id_imageAdvertisement_3', src: '/img/advertisement_3.jpg', style: {width: '100%', height: '100%'}})
                    )
                ),
                D.img({id: 'id_imgFireworks', src: '/img/fireworks.gif', style: {display: fireworksDiaplayMode}}),
                // D.div({ className: 'max-profit' },
                //     (languageFlag ? 'Max profit: ' : 'Max profit'), (Engine.maxWin).toFixed(0), ' bits'
                // ),
                objGameInfo
            );
        }
