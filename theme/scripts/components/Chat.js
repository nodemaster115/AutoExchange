    ...
    return React.createClass({
        ...
        render: function () {
            ...
            if (ChatEngine.state === 'DISCONNECTED') {
                return D.div({ id: 'chatModal', className: 'modal fade modeless'},
                    D.div({ className: 'modal-dialog'},
                        D.div({ className: 'modal-content modal-content-chat', style: {'backgroundColor': '#2e2e2e', 'opacity': '0.9', 'boxShadow': 'inset 0px 0px 10px 1px #fff'}},
                            D.div({ className: 'modal-header'},
                                D.button({ 'type': 'button', className: 'close', 'data-dismiss': 'modal', 'aria-hidden': 'true', id: 'close_chat_button'}, '&times;'),
                                D.i({ className: 'icon-bubble font-red-sunglo', style: { marginRight: '8px' } }),
                                D.span({ className: 'caption-subject font-red-sunglo bold uppercase' }, 'Chat')
                            ),
                            D.div({ className: 'modal-body', style: { 'padding': '0'}},
                ...
                D.div({ className: 'modal-dialog'},
                    D.div({ className: 'modal-content modal-content-chat', style: {'backgroundColor': '#2e2e2e', 'opacity': '0.9', 'boxShadow': 'inset 0px 0px 10px 1px #fff'}},
                        D.div({ className: 'modal-header'},
                            D.button({ 'type': 'button', className: 'close', 'data-dismiss': 'modal', 'aria-hidden': 'true', id: 'close_chat_button'}, '&times;'),
                            D.i({ className: 'icon-bubble font-red-sunglo', style: { marginRight: '8px' }}),
                            D.span({ className: 'caption-subject font-red-sunglo bold uppercase'}, languageFlag ? 'Chat' : '在线聊天')
                        ),
                        D.div({ className: 'modal-body', style: { 'padding': '0'}},
                            D.div({ className: 'row'},
                                D.div({ className: 'col-md-12'},
                                    D.div({ className: 'portlet light', style: {'padding': '10px', 'marginBottom': '0'}},
