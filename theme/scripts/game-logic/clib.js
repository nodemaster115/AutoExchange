define([
    ...
    return {
        ...
        parseRangeBet: function (rangeBetString, minRangeBet, maxRangeBet) {
            rangeBetString = String(rangeBetString);

            if (!/^\d+k*$/.test(rangeBetString)) { return new Error('Extra-Bet may only contain digits, and k (to mean 1000)'); }
