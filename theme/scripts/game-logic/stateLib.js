...
define([
    ...
    return {
        ...
        isBetting: function (engine) {
            ...
            if (engine.nextBetAmount || engine.nextRangeBetAmount) return true;
        ...
        canUserBet: function (balanceSatoshis, betStringBits, extraBetStringBits, rangeBetStringBits, betInvalid, autoCashOutInvalid,
                              nMinBetAmount, nMaxBetAmount, nMinExtraBetAmount, nMaxExtraBetAmount, nMinRangeBetAmount, nMaxRangeBetAmount) {
            var betBet = this.parseBet(betStringBits);
            var betExtraBet = this.parseBet(extraBetStringBits);
            var betRangeBet = this.parseBet(rangeBetStringBits);
            ...
            if (balanceSatoshis < betBet + betExtraBet + betRangeBet) {
            ...
            } else if(betBet == 0 && betExtraBet == 0 && betRangeBet > 0) {
                if ((betRangeBet > 0 && betRangeBet < nMinRangeBetAmount) || betExtraBet > nMaxRangeBetAmount) {
