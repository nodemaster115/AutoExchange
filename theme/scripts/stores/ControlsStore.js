define([
    ...
    //Range Bet Size
    var _rangeBetSize = Clib.localOrDef('rangeBetSize', '0');
    var _rangeBetID = Clib.localOrDef('rangeBetID', 1);
    ...
    var ControlsStore = _.extend({}, Events, {
        ...
        _setRangeBetSize: function (rangeBetSize) {
            _rangeBetSize = rangeBetSize;

            var rangeBet = Clib.parseRangeBet(rangeBetSize, Engine.nMinRangeBetAmount, Engine.nMaxRangeBetAmount);
            if (rangeBet instanceof Error) { _rangeBetInvalid = rangeBet.message; } else { _rangeBetInvalid = false; }

            localStorage['rangeBetSize'] = _rangeBetSize;
        },

        _setRangeBetID: function (rangeBetID) {
            _rangeBetID = parseInt(rangeBetID);
            localStorage['rangeBetID'] = parseInt(_rangeBetID);
        },
    ...
    AppDispatcher.register(function (payload) {
        ...
        switch (action.actionType) {
            ...
            case AppConstants.ActionTypes.SET_RANGE_BET_SIZE:
                ControlsStore._setRangeBetSize(action.rangeBetSize);
                ControlsStore.emitChange();
                break;
